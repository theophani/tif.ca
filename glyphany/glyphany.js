(function () {
  window.showGlyphany = function() {
    ...
    lt += 'span#glyphany_close{cursor:pointer;position:absolute;top:10px;right:10px;background-color:#0080C0;color:#fff;font-family:Helvetica,Arial,sans-serif;}';
    lt += 'span#glyphany_close{-webkit-border-radius: 1em;-moz-border-radius:1em;border-radius:1em;}';
